  ...
  return (
    ...
    >
      <div className="mx-auto max-w-7xl px-4 py-20 md:px-8 lg:px-10">
        <h2 className="mb-4 max-w-4xl text-lg text-black dark:text-white md:text-4xl">My Work Journey</h2>
        <p className="max-w-sm text-sm text-neutral-700 dark:text-neutral-300 md:text-base">
          Here is a timeline of my professional journey and accomplishments.
        </p>
      </div>
